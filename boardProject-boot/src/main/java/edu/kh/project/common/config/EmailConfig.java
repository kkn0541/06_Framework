...
public class EmailConfig {
	...
	//@Value : properies 에 작성된 내용 중 key가
	//일치하는 value값을 얻어와 필드에 대입 
	...
	public JavaMailSender javaMailSender()  {
		/*
		 * 
		 * Spring에서 javaMailSender 를 구성하는 bean을 정의 
		 * 
		 * JavaMailSender : 이메일을 보내는데 사용하는 인터페이스로 
		 * 
		...
		return mailSender; //위처럼 각종 설정이 적용된 JavaMailSender를 Bean 으로 등록하여
