...
/*
 * 스프링에서 예외 처리 방법 (우선 순위별로 작성) 
 * 
 * 1. 메서드에서 직접 처리 (try -catch , throws) 
 * 
 * 2. 컨트롤러 클래스에서 클래스단위로 모아서 처리 
 * (@ExcetpionHanler 어노테이션을 지닌 메서드를 작성 )
 * 
 ...
 * 
 * */
@ControllerAdvice // 전역전 예외 처리 활성화 어노테이션 
public class ExceptionController {

	// @ExceptionHandler(예외 종류 )  : 어떤 예외를 다룰건지 작성 
	
	// 예외 종류 : 메서드별로 처리할 예외를 지정 
	// SQLExeption.class - SQL 관련된 예외만 처리 
 ...
 * 
 * 500 : 서버 내부 오류 ( Internal Server Error ) 서버에서 코드 잘못짰을때 
 * 
 * 
 * 
 * */
