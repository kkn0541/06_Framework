...
--TO_CHAR(BOARD_WRITE_DATE,'YYYY"년" MM"월"DD"일" HH24:24:MI:SS')BOARD_WRITE_DATE,
--TO_CHAR(BOARD_UPDATE_DATE,'YYYY"년" MM"월"DD"일" HH24:24:MI:SS')BOARD_UPDATE_DATE,
--(SELECT COUNT(*)
--FROM "BOARD_LIKE"
--WHERE BOARD_NO= 1995
--) LIKE_COUNT,  -- 좋아요 개수 
--
--(SELECT IMG_PATH || IMG_REANAME
--FROM "BOARD_IMG"
--WHERE BOARD_NO=1995
--ANG IMG_ORDER =0 )THUMBNAIL, -- 이미지 순서가 0이고 NO가 1995 인 
--
--(SELECT COUNT(*)
--FROM "BOARD_LIKE"
--WHERE BOARD_NO =1995
...
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1',
			  DEFAULT, DEFAULT,	1995, 2, 2003);
			 
-- 부모 댓글 2의 자식 1의 자식 댓글			 
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1의 자식!!!', --3레벨
			  DEFAULT, DEFAULT,	1995, 1, 2007);
...
OR 0 != (SELECT COUNT(*) FROM "COMMENT" SUB
				...
				--> 삭제된 댓글이라도 , 그아래에 활성상태인 자식 댓글이 존재하면 조회 
START WITH PARENT_COMMENT_NO IS NULL
CONNECT BY PRIOR COMMENT_NO = PARENT_COMMENT_NO
ORDER SIBLINGS BY COMMENT_NO  -- SIBLINGS- 같은 레벨 
;
...
VALUES(2, 2007); -- 1번 회원이 1998번 글에 좋아요를 클릭함
...
-- 가장 마지막 "/" 찾기
--/myPage/profile/20241112153025_00002.jpg
...
--MEMBER테이블의 PROFILE_IMG(VARCHAR2(300)
--BOARD_IMG 테이블의 IMG_RENAME(NVARCAHR2(50);
...
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 1의 자식 1',
			  DEFAULT, DEFAULT,	2008, 1, 4002);
			 
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 1의 자식 2',
			  DEFAULT, DEFAULT,	2008, 2, 4002);
			 
			 
-- 부모 댓글 2의 자식 댓글			 
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1',
			  DEFAULT, DEFAULT,	2008, 2, 4003);
			 
-- 부모 댓글 2의 자식 1의 자식 댓글			 
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1의 자식!!!',
			  DEFAULT, DEFAULT,	2008, 2, 4007);
